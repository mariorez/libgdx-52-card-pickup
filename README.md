...
In the solitaire card game 52 Card Pickup, the 52 cards of a standard deck of playing cards are scattered around randomly; the goal is to arrange the cards into piles.

![alt text](52-card-pickup.png "52 Card Pickup")
